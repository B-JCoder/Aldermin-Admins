  ...
  return (
    <div className="container mx-auto space-y-12 pb-20">
      ...
      <div className="max-w-4xl mx-auto w-full">
        <GlassCard className="p-10 bg-gradient-to-br from-white to-secondary/5 relative overflow-hidden">
          <h4 className="mb-10 text-xs font-black text-muted-foreground uppercase tracking-[0.3em] leading-none flex items-center justify-between">
          ...
          <form className="space-y-10 relative">
              ...
              <div className="space-y-8">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="date"
                      className="w-full rounded-2xl border-secondary/20 bg-secondary/5 p-4 pl-10 text-[10px] font-black focus:bg-white outline-none transition-all shadow-inner"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative group">
                    <label className="w-full flex items-center gap-3 p-4 rounded-2xl bg-white/40 border border-dashed border-white/60 text-[10px] font-black text-muted-foreground uppercase tracking-widest cursor-pointer group-hover:bg-white group-hover:border-secondary/40 transition-all shadow-sm">
                      <FaFileAlt
                        size={14}
                        className="text-muted-foreground/40 group-hover:text-secondary"
                      />
                      Attach Guidelines
            ...
            <div>
              ...
              <div className="relative">
                <FaInfoCircle
                  className="absolute left-4 top-4 text-muted-foreground/40"
                  size={12}
                />
                <textarea
                  className="w-full rounded-3xl border-white/40 bg-white/50 p-8 pl-10 text-xs font-bold focus:bg-white outline-none transition-all shadow-sm min-h-[150px] leading-relaxed italic"
