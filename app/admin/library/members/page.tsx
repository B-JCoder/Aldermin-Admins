            ...
            <form className="space-y-4 flex-1">
              <div>
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 px-1 text-nowrap">
                  Membership Modality <span className="text-red-500">*</span>
                </label>
                <div className="relative">
                  ...
                  <select className="w-full rounded-2xl border-gray-100 p-4 pl-10 text-xs font-bold focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all bg-white shadow-sm appearance-none cursor-pointer">
                    <option>Student Archetype</option>
                    <option>Staff Archetype</option>
                  </select>
                </div>
              </div>
              ...
              <div>
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 px-1 text-nowrap">
                  Industrial Member ID <span className="text-red-500">*</span>
                </label>
                <div className="relative">
                  <FaIdCard
                    className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300"
                  ...
                  <input
                    type="text"
                    className="w-full rounded-2xl border-gray-100 p-4 pl-10 text-xs font-mono font-bold focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all bg-white shadow-sm"
          ...
          <div className="rounded-3xl bg-white p-8 shadow-xl border border-gray-100 ring-1 ring-black/5 relative overflow-hidden h-full">
            ...
            <div className="overflow-x-auto rounded-2xl border border-gray-50 relative">
              <table className="min-w-full text-sm">
                <thead className="bg-gray-50/70 text-gray-400 font-bold border-b border-gray-50 uppercase tracking-widest text-[9px]">
                  <tr>
                    <th className="px-6 py-5 text-left w-16">SN</th>
                    <th className="px-6 py-5 text-left">Identity Profile</th>
                    <th className="px-6 py-5 text-left">Communication Nodes</th>
                    ...
                    >
                      ...
                      <td className="px-6 py-8">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center text-emerald-600 ring-4 ring-emerald-50 group-hover:bg-emerald-600 group-hover:text-white transition-all duration-300 shadow-sm">
