            ...
            <form className="space-y-4 flex-1">
              <div>
                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2 px-1 text-nowrap">
                  Subject Appellation <span className="text-red-500">*</span>
                </label>
                  ...
                  {subjects.map((s, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-8 text-center">
                        <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-gray-50 rounded-lg border border-gray-100 text-[10px] font-mono font-bold text-gray-600 uppercase tracking-tighter group-hover:bg-white group-hover:text-emerald-700 transition-all">
