    ...
    <div className="container mx-auto p-4 space-y-8">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button className="px-6 py-2.5 bg-gray-900 text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-black transition-all shadow-lg shadow-gray-200 active:scale-95">
            Generate Batch
          </button>
        </div>
      </div>
      ...
      <div className="rounded-[2rem] bg-white p-8 shadow-xl border border-gray-100 ring-1 ring-black/5">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-end">
          ...
          <button className="w-full bg-emerald-600 text-white rounded-2xl py-4 text-xs font-black uppercase tracking-widest hover:bg-emerald-700 transition-all shadow-lg shadow-emerald-100 active:scale-[0.98]">
            Query Matrix
          </button>
        </div>
      </div>
                ...
                >
                  ...
                  <td className="px-6 py-10 text-center">
                    <div className="inline-flex flex-col">
                      <span
                        className="font-black text-gray-900 font-mono text-lg tracking-tighter cursor-help"
                  ...
                  <td className="px-6 py-10 text-center">
                    <div className="flex flex-col items-center">
                      <div className="flex items-center gap-1.5 px-3 py-1 bg-gray-50 rounded-lg border border-gray-100">
                        ...
                        <span className="text-[11px] font-black font-mono text-gray-500 uppercase">
                          {inv.dueDate}
                        </span>
                      </div>
                      <span className="text-[8px] font-black text-gray-300 uppercase tracking-widest mt-2 italic font-serif">
                        Deadline Horizon
                      </span>
                    </div>
                  </td>
                  <td className="px-6 py-10 text-center">
                    <span
                      className={`inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-sm ring-1 ring-inset ${
                        inv.status === "Paid"
