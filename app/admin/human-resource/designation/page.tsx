...
export default function DesignationPage() {
  const [designations, setDesignations] = useState([
    { id: 1, title: "Principal Academic Officer" },
    { id: 2, title: "Senior Faculty Head" },
    { id: 3, title: "Administrative Director" },
  ]);
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold text-gray-900 tracking-tighter flex items-center gap-3">
          <div className="p-2 bg-sky-600 rounded-xl shadow-lg ring-4 ring-sky-50">
            <FaUserTag className="text-white" size={20} />
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8">
          <div className="rounded-3xl bg-white p-8 shadow-xl border border-gray-100 ring-1 ring-black/5 relative overflow-hidden h-full">
            <div className="absolute top-0 right-0 w-64 h-64 bg-sky-50/20 rounded-full blur-3xl -mr-32 -mt-32"></div>

            <div className="flex items-center justify-between mb-8 relative">
              <h4 className="text-xs font-semibold text-gray-400   leading-none">
                Designation Hierarchy Index
              </h4>
            </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-8">
                        <div className="flex items-center gap-4">
                          <div className="w-10 h-10 rounded-full bg-sky-50 flex items-center justify-center text-sky-500 scale-0 group-hover:scale-100 transition-transform duration-300 shadow-inner">
                            <FaSitemap size={12} />
                          </div>
