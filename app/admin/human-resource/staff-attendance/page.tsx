            ...
            <tbody className="divide-y divide-gray-50">
              {attendanceList.map((a, index) => (
                ...
                >
                  ...
                  <td className="px-8 py-10">
                    <div className="flex items-center justify-center gap-8">
                      <div className="text-center">
                        <div className="text-[10px] font-black text-gray-300 uppercase tracking-[0.1em] mb-1">
                          Clock In
                        </div>
                        <div className="font-mono text-xs font-bold text-gray-600 flex items-center gap-1">
                          <FaClock size={10} className="text-sky-300" />{" "}
                          {a.clockIn}
                        </div>
                      </div>
                      <div className="text-center">
                        <div className="text-[10px] font-black text-gray-400 uppercase tracking-[0.1em] mb-1">
                          Clock Out
                        </div>
                        <div className="font-mono text-xs font-bold text-gray-600 flex items-center gap-1">
                  ...
                  <td className="px-8 py-10 text-center">
                    <button className="px-5 py-2.5 bg-gray-50 text-gray-400 text-[9px] font-black rounded-xl uppercase tracking-widest hover:bg-sky-600 hover:text-white transition-all shadow-sm border border-gray-100">
                      View Dossier
                    </button>
                  </td>
                </tr>
