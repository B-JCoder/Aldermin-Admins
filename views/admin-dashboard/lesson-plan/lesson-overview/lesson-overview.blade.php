...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Lesson Overview</h4>
    </div>
...
<div class="row">
    <div class="col-4 md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="text-themecolor mb-3">Lesson Overview</h4>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="teacher">Teacher</label> <span class="text-danger">*</span>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Lesson Overview</h4>
