...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Topic</h4>
    </div>
...
<div class="row">
    <div class="col-4 md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="text-themecolor mb-3">Topic</h4>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="content-title">Topic Title</label> 
                                    <input type="text" class="form-control" name="content-title" id="content-title" placeholder="" value="">
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label for="content-type">Class</label> <span class="text-danger">*</span>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="available-for">Section</label> <span class="text-danger">*</span>
                                    <select class="select2 form-control custom-select" name="available-for" style="width: 100%; height:36px;">
                                        <option value="">Select</option>
                                    </select>
                                </div>

                                <div class="col-md-12 mb-3">
                                    <label for="available-for">Subject</label> <span class="text-danger">*</span>
                                    <select class="select2 form-control custom-select" name="available-for" style="width: 100%; height:36px;">
                                        <option value="">Select</option>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="lesson">Lesson</label> <span class="text-danger">*</span>
                                    <select class="select2 form-control custom-select" name="lesson" style="width: 100%; height:36px;">
                                        <option value="">Select</option>
                                    </select>
                                </div>
