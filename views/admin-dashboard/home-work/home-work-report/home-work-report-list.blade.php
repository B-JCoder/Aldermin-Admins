...
@section('title', 'Homework Report List')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Homework Report List</h4>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"> Search Homework</h4>
                <div class="row">
                    <div class="col-md-12">
...
<script>
    ...
    $('#homework_date').bootstrapMaterialDatePicker({
        weekStart: 0,
        time: false
    });
</script>
