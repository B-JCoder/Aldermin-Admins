...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Library Member</h4>
    </div>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3">
                                    <label for="">Member Type</label>  <span class="text-danger">*</span>
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="first_name">Member ID</label>  <span class="text-danger">*</span>
