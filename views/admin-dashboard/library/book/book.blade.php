                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3"> 
                                    <label for="first_name">Book Title</label> <span class="text-danger">*</span>  
                                    <input type="text" class="form-control" name="first_name" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                
                                <div class="col-md-6 mb-3">
                                    <label for="book-categories">Book Categories</label> <span class="text-danger">*</span>
                                    <select class="select2 form-control custom-select" name="book-categories" style="width: 100%; height:36px;">
                                ...
                                <div class="col-md-6 mb-3"> 
                                    <label for="book-number">Book Number</label> <span class="text-danger">*</span>  
                                    <input type="text" class="form-control" name="book-number" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="isbn-number">ISBN Number</label> 
                                    <input type="text" class="form-control" name="isbn-number" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="publisher-name">Publisher Name</label> 
                                    <input type="text" class="form-control" name="publisher-name" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="author-name">Auther Name</label> 
                                    <input type="text" class="form-control" name="author-name" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="rack-name">Rack Name</label> 
                                    <input type="text" class="form-control" name="rack-name" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3"> 
                                    ...
                                    <input type="text" class="form-control" name="book-price" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
