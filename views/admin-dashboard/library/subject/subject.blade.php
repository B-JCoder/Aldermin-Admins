...
<div class="row">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                <div class="col-md-12 mb-3"> 
                                    <label for="subject-name">Subject Name</label> <span class="text-danger">*</span>  
                                    <input type="text" class="form-control" name="subject-name" placeholder="" value="">
                                ...
                                <div class="col-md-12 mb-3"> 
                                    <label for="subject-code">Subject Code</label> <span class="text-danger">*</span>  
                                    <input type="text" class="form-control" name="subject-code" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div> 
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Fee Group List</h4>
