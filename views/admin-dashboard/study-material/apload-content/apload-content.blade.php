...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Apload Content</h4>
    </div>
...
<div class="row">
    <div class="col-4 md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="text-themecolor mb-3">Apload Content</h4>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="content-title">Content Title</label> <span class="text-danger">*</span>
                                    <input type="text" class="form-control" name="content-title" id="content-title" placeholder="" value="">
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label for="content-type">Content Type</label> <span class="text-danger">*</span>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="available-for">Available For</label> <span class="text-danger">*</span>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Apload Content</h4>
