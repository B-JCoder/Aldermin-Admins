...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Online Exam</h4>
    </div>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="">Group</label>  <span class="text-danger">*</span>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="discription">Question</label> <span class="text-danger">*</span>
                                    <textarea class="form-control" name="" id=""></textarea>
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="mark">Marks</label> <span class="text-danger">*</span>  
                                    <input type="text" class="form-control" name="mark" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
