                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3"> 
                                    <label for="complaint-by">Complaint By</label> <span class="text-danger">*</span>  
                                    <input type="text" class="form-control" name="complaint-by" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3">
                                    <label for="complaint-type">Complaint Type</label> <span class="text-danger">*</span>
                                    <select class="select2 form-control custom-select" name="complaint-type" style="width: 100%; height:36px;">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="complaint-source">Complaint Source</label> <span class="text-danger">*</span>
                                    <select class="select2 form-control custom-select" name="complaint-source" style="width: 100%; height:36px;">
                                        <option value="">Select</option>
                                    </select>
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3"> 
                                    ...
                                    <input type="text" class="form-control" name="action-taken" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="assigned">Assigned</label>  
                                    <input type="text" class="form-control" name="assigned" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
...
<script>
    ...
    $('#date, #time-in, #time-out').bootstrapMaterialDatePicker({
        weekStart: 0,
        time: false
    });
</script>
