...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Certificate</h4>
    </div>
                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3"> 
                                    <label for="name">Certificate Name</label> <span class="text-danger">*</span>  
                                    <input type="text" class="form-control" name="name" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="name">Header Left Text</label> 
                                    <input type="text" class="form-control" name="name" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3"> 
                                    <label for="body-min">Body (Minimum 500 characters)</label>   
                                    <input type="text" class="form-control" name="body-min" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="body-max">Body (Max 500 characters)</label> 
                                    <input type="text" class="form-control" name="body-max" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="">Font Size</label>  <span class="text-danger">*</span>
                                    <input type="file" class="form-control" name="photo">
                                    <div class="text-info mt-2">(pdf, doc, docx, jpg, jpeg, png, txt are allowed.)</div>
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="width">Footer Left Text</label> 
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="form-group">
                                        <label class="form-label d-block">Student Photo</label>
