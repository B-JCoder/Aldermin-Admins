...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Generate ID Card</h4>
    </div>
                    ...
                    <div class="col-md-12">
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="">Select ID Card</label>  <span class="text-danger">*</span>
                                    <select class="select2 form-control custom-select" name=" " style="width: 100%; height:36px;">
                                        <option value="">Select</option>
                                    </select>
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                ...
                                <div class="col-md-12 mb-3"> 
                                    <label for="grip-gap">Grip Gap (px)</label> <span class="text-danger">*</span>  
                                    <input type="text" class="form-control" name="grip-gap" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>   
