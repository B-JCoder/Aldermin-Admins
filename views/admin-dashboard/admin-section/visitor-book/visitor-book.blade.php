...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Visitor Book</h4>
    </div>
...
<div class="row">
                    ...
                    <div class="col-md-12">
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3"> 
                                    <label for="id-card">ID Card</label> <span class="text-danger">*</span>  
                                    <input type="text" class="form-control" name="id-card" placeholder="" value="">
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                </div>

                                <div class="col-md-6 mb-3"> 
                                    <label for="percent-to">No. of Persons</label> <span class="text-danger">*</span>  
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="time-in" id="time-in" placeholder="" value="">
                                </div>

                                <div class="col-md-4 mb-3">
                                    <label for="time-out">Time Out</label>
                                    <input type="text" class="form-control" name="time-out" id="time-out" placeholder="" value="">
                                </div>
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Visitor Book List</h4>
