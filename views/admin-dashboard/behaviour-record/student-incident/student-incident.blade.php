...
@section('title', 'Student Incident')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Student Incident Report</h4>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"> Search Incident</h4>
                <div class="row">
                    <div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Student Incident List</h4>
