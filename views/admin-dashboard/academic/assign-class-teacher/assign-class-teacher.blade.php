...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Assign Class Teacher</h4>
    </div>
...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Add Assign Class Teacher</h4>
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="">Select Class</label>  <span class="text-danger">*</span>
                                ...
                                <div class="col-md-6 mb-3">
                                    <label for="">Select Section</label>  <span class="text-danger">*</span>
                                    <select class="select2 form-control custom-select" name=" " style="width: 100%; height:36px;">
                                        <option value="">Select</option>
                                    </select>
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
                                ...
                                <div class="col-md-12 mb-3">
                                    <label for="">Select Teacher</label>  <span class="text-danger">*</span>
                                    <select class="select2 form-control custom-select" name=" " style="width: 100%; height:36px;">
                                        <option value="">Select</option>
                                    </select>
                                    @error('')<div class="text-danger">{{ $message }}</div>@enderror
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Assign Class Teacher List</h4>
