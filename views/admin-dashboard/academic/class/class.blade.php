                        ...
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="first_name">Class Name</label>  <span class="text-danger">*</span>
                                        ...
                                        <div class="input-group d-flex align-items-center">
                                            <ul class="icheck-list d-flex mb-0">
                                                <li class="d-flex align-items-center">
                                                    <label for="is_mandatory" class="mr-4 mb-0">Section A</label>
                                                    <input type="checkbox" class="check" id="is_mandatory" name="is_mandatory" value="1" data-radio="iradio_square-red">
                                                </li>
                                            </ul>
                                            @error('is_tuition_fee')<div class="text-danger">{{ $message }}</div>@enderror
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <div class="input-group d-flex align-items-center">
                                            <ul class="icheck-list d-flex mb-0">
                                                <li class="d-flex align-items-center">
                                                    <label for="is_mandatory" class="mr-4 mb-0">Section B</label>
                                                    <input type="checkbox" class="check" id="is_mandatory" name="is_mandatory" value="1" data-radio="iradio_square-red">
                                                </li>
                                            </ul>
                                            @error('is_tuition_fee')<div class="text-danger">{{ $message }}</div>@enderror
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="input-group d-flex align-items-center">
                                            <ul class="icheck-list d-flex mb-0">
                                                <li class="d-flex align-items-center">
                                                    <label for="is_mandatory" class="mr-4 mb-0">Section C</label>
                                                    <input type="checkbox" class="check" id="is_mandatory" name="is_mandatory" value="1" data-radio="iradio_square-red">
                                                </li>
                                            </ul>
                                            @error('is_tuition_fee')<div class="text-danger">{{ $message }}</div>@enderror
