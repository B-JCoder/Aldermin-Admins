...
@section('title', 'Student-wise Attendance List')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Student-wise Attendance List</h4>
    </div>
...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Student-wise Attendance List</h4>
...
<script src="{{ url('assets/node_modules/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js') }}"></script>0
