...
@section('title', 'Student Promote List')
...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Student Promote List</h4>
    </div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"> Search Student Promote</h4>
                <div class="row">
                    <div class="col-md-12">
                        <form method="POST" action="" enctype="multipart/form-data" novalidate>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                    <label for="">Academic Year</label>  <span class="text-danger">*</span>
                                ...
                                <div class="col-md-4 mb-3">  <span class="text-danger">*</span>
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Student Promote List</h4>
                        ...
                        <tbody id="tbl_data">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-info">Promote/Update ></button>
                                </td>
                            </tr>
                            @php $sn++ @endphp
