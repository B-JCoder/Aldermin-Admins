      ...
      <form onSubmit={handleSubmit} className="space-y-6 flex-1">
        <div className="space-y-2">
          ...
          <Input
            ...
            className="w-full rounded-2xl border-border/50 bg-secondary/5 pl-4 h-12 text-sm font-bold focus:ring-secondary/20 shadow-sm placeholder:text-muted-foreground/50"
        ...
        <div className="flex items-center gap-4 bg-secondary/5 p-4 rounded-2xl border border-secondary/10">
          <Button
            ...
            className={`w-10 h-10 rounded-xl flex items-center justify-center transition-all p-0 ${
              isMandatory
                ...
                : "bg-white text-muted-foreground border border-border/50 shadow-sm hover:bg-secondary/10"
            }`}
          >
          ...
          <div>
            ...
            <div className="text-[9px] font-bold text-muted-foreground lowercase italic">
