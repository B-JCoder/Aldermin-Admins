      ...
      <div className="p-6">
        <div className="overflow-x-auto rounded-xl">
          <table className="min-w-full text-sm">
            <thead className="bg-gray-50/50 text-gray-400 font-semibold">
              <tr>
              ...
              {overviews.map((item, index) => (
                ...
                >
                  ...
                  <td className="px-6 py-5">
                    <div className="font-semibold text-gray-800 tracking-tight leading-none mb-1">
                      {item.lesson}
                    </div>
                  ...
                  <td className="px-6 py-5">
                    <span className="inline-block px-2 py-0.5 bg-secondary/10 text-secondary text-[10px] font-semibold  rounded ring-1 ring-secondary/20">
                      {item.subjectTopic}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-5">
                    <div className="flex justify-center">
                      <span
                        className={`px-3 py-0.5 rounded-full text-[10px] font-semibold  tracking-tighter ${
