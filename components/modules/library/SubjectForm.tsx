      ...
      <form className="space-y-4 flex-1">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              type="text"
              className="w-full rounded-2xl border-border/50 bg-secondary/5 p-4 pl-10 text-xs font-mono font-bold focus:ring-4 focus:ring-secondary/10 outline-none transition-all shadow-sm placeholder:text-muted-foreground/50"
