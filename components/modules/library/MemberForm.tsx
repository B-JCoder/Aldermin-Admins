      ...
      <form className="space-y-6">
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <Input
              type="text"
              className="w-full rounded-2xl border-border/50 bg-secondary/5 pl-10 h-10 text-xs font-bold focus:ring-secondary/20 shadow-sm placeholder:text-muted-foreground/50"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <Input
                type="text"
                className="w-full rounded-2xl border-border/50 bg-secondary/5 pl-10 h-10 text-[10px] font-mono font-bold focus:ring-secondary/20 shadow-sm placeholder:text-muted-foreground/50"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <Input
                type="email"
                className="w-full rounded-2xl border-border/50 bg-secondary/5 pl-10 h-10 text-[10px] font-bold focus:ring-secondary/20 shadow-sm placeholder:text-muted-foreground/50"
