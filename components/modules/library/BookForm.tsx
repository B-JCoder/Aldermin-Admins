      ...
      <form className="space-y-6">
        <div className="grid grid-cols-1 gap-4">
          <div className="space-y-1">
            <label className="text-[9px] font-semibold text-gray-500   ml-1">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                className="w-full rounded-2xl border-border/50 bg-secondary/5 p-3.5 pl-10 text-xs font-bold focus:ring-4 focus:ring-secondary/10 outline-none transition-all shadow-sm  placeholder:text-gray-500/50"
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  className="w-full rounded-2xl border-border/50 bg-secondary/5 p-3.5 pl-10 text-[10px]  font-bold focus:ring-4 focus:ring-secondary/10 outline-none transition-all shadow-sm placeholder:text-gray-500/50"
                  placeholder="B-..."
                />
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              ...
              <div className="relative ">
                ...
                <input
                  type="text"
                  className="w-full rounded-2xl border-border/50 bg-secondary/5 p-3.5 pl-10 text-[9px] font-bold focus:ring-4 focus:ring-secondary/10 outline-none transition-all shadow-sm placeholder:text-gray-500/50"
                  placeholder="000-000..."
                />
              </div>
            </div>
          ...
          <div className="space-y-1">
            ...
            <div className="relative">
              ...
              <input
                type="text"
                className="w-full rounded-2xl border-border/50 bg-secondary/5 p-3.5 pl-10 text-xs  font-semibold focus:ring-4 focus:ring-secondary/10 outline-none transition-all shadow-inner placeholder:text-gray-500/50"
                placeholder="0.00"
              />
            </div>
          </div>
