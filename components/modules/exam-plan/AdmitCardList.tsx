        ...
        <Table>
          <TableHeader className="bg-secondary/5">
            <TableRow className="hover:bg-transparent">
              <TableHead className="px-5 py-4 text-left w-16 text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                SN
              </TableHead>
              <TableHead className="px-5 py-4 text-left text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                Student Name
              </TableHead>
              <TableHead className="px-5 py-4 text-left text-[10px] font-black uppercase tracking-widest text-muted-foreground">
                Admission No
              ...
              <TableHead className="px-5 py-4 text-center">
                <div className="flex items-center justify-center gap-2">
                  <span className="text-[10px] uppercase tracking-tighter font-black text-muted-foreground">
                    Toggle All
                  </span>
                  <Checkbox
          ...
          <TableBody className="divide-y divide-border/50">
            {students.map((item, index) => (
              ...
              >
                ...
                <TableCell className="px-5 py-4 font-black text-foreground">
                  {item.name}
                </TableCell>
                <TableCell className="px-5 py-4">
                  <span className="text-xs font-black text-secondary bg-secondary/10 px-2 py-0.5 rounded tracking-tighter">
                    {item.admissionNo}
                  </span>
                </TableCell>
                ...
                <TableCell className="px-5 py-4">
                  <span className="text-[10px] font-bold text-muted-foreground px-2 py-0.5 rounded-full bg-secondary/5 ring-1 ring-secondary/10">
                    {item.category}
                  </span>
                </TableCell>
                <TableCell className="px-5 py-4 text-muted-foreground/70 text-xs font-bold uppercase">
                  {item.gender}
                </TableCell>
